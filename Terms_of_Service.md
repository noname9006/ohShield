...
- You must be at least 13 years old, or the minimum age required by Discord's Terms of Service in your jurisdiction, to use ohShield.
- If you are adding ohShield to a server on behalf of an organization, you represent that you have the authority to bind that organization to these Terms.
- Use of ohShield is subject to and must comply with [Discord's Terms of Service](https://discord.com/terms) and [Discord's Developer Policy](https://discord.com/developers/docs/policies-and-agreements/developer-policy).

## 3. Adding ohShield to Your Server

- Server owners and administrators are responsible for reviewing the permissions requested by ohShield before adding it to a server.
- You are responsible for configuring the Bot appropriately for your server, including verification settings and any roles assigned by the Bot.
- You may remove ohShield from your server at any time via Discord's server settings.

## 4. Acceptable Use

You agree not to:

- Use ohShield for any unlawful purpose or in violation of Discord's Terms of Service or Community Guidelines.
- Attempt to interfere with, disrupt, reverse-engineer, or circumvent the Bot's verification or security mechanisms.
- Use the Service to harass, discriminate against, or unlawfully target any individual or group.
- Misrepresent your affiliation with ohShield or use our branding without permission.
- Use automated means to abuse, overload, or scrape the Bot, dashboard, or associated infrastructure.

We reserve the right to suspend or terminate access to the Service for any user or server found in violation of these Terms.

## 5. Verification Process & Disclaimer

ohShield's verification and anti-scam features are designed to reduce risk, not eliminate it entirely. **We do not guarantee that use of ohShield will prevent all scams, phishing attempts, impersonation, or malicious activity on your server.** Server administrators remain responsible for their own moderation policies and decisions. You acknowledge that no automated system can catch every threat, and you agree to use ohShield as one part of a broader moderation strategy, not as a sole safeguard.
...
*By using ohShield, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.*